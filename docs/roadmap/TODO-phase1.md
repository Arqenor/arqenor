...
## SECTION A — arqenor-core : modèles + moteur de règles

- [x] **A1** — Ajouter `Alert` model avec champ `attack_id: String` et `severity: Severity`
  - fichier : `rust/arqenor-core/src/models/alert.rs` (existe, à compléter)
...
## SECTION B — arqenor-platform (Windows) : persistence étendue

> fichier cible : `rust/arqenor-platform/src/windows/persistence.rs`
...
- [x] Ajouter `WmiSubscription` au enum `PersistenceKind` dans arqenor-core
...
## SECTION C — arqenor-platform (Linux) : persistence étendue

> fichiers cibles : `rust/arqenor-platform/src/linux/persistence_detector.rs`
...
## SECTION D — arqenor-platform (Windows) : règles LOLBin

> fichier : `rust/arqenor-core/src/rules/lolbin.rs`
...
> fichier : `rust/arqenor-platform/src/windows/cred_guard.rs`
...
> module : `rust/arqenor-platform/src/fim.rs`
...
> fichiers : `rust/arqenor-tui/src/app.rs` + `arqenor-desktop/src-tauri/src/lib.rs`
...
> fichiers : `arqenor-desktop/src/pages/Alerts.tsx` + mises à jour connexes
...
|-------|----------|--------|
| `arqenor-core` | A1, A2, A3 | ✅ |
| `arqenor-platform` | B1–B9, E1–E6, F1–F5 | ✅ (stubs: B3, E1, E4) |
| `arqenor-tui` | G | ✅ |

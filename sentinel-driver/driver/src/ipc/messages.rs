...
//!
//! Re-exports `KernelEvent` from `sentinel-driver-common` and provides a
...
pub const MAX_SERIALIZED_EVENT_BYTES: usize = sentinel_driver_common::MAX_EVENT_SIZE;
...
pub use sentinel_driver_common::KernelEvent;

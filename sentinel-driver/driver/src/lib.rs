//! SENTINEL kernel driver — main entry point.
//!
//! Architecture:
...
//!   - FltCreateCommunicationPort: IPC channel to the SENTINEL usermode agent
//!
...
pub struct DriverState {
    ...
    /// PID of the SENTINEL usermode agent being protected. 0 = inactive.

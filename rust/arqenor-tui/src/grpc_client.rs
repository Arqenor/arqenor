...
// `arqenor.host` references `super::super::common::Alert` (two levels up from
...
/// The protobuf Alert type from `arqenor.common`.
...
/// Drives a persistent alert stream from `arqenor-grpc` on `127.0.0.1:50051`.
///
